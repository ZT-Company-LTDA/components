import React__default, { useState, useEffect, useMemo, useCallback, createElement } from 'react';
import { useSession, signOut } from 'next-auth/react';
import { IoDocumentAttach, IoEyeOutline } from 'react-icons/io5';
import { HiIdentification } from 'react-icons/hi2';
import { Image, Navbar, NavbarContent, NavbarMenuToggle, NavbarBrand, NavbarItem, Dropdown, DropdownTrigger, Avatar, DropdownMenu, DropdownItem, NavbarMenu, NavbarMenuItem, Link, Tooltip, Button, useDisclosure, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Pagination, Chip, User, Input, Table, TableHeader, TableColumn, TableBody, Spinner, TableRow, TableCell } from '@nextui-org/react';
...
var SideBar = function SideBar(_ref2) {
  ...
  }, React__default.createElement(NavbarContent, {
    className: "md:hidden",
    justify: "start"
  }, React__default.createElement(NavbarMenuToggle, {
    "aria-label": isMenuOpen ? "Close menu" : "Open menu"
  })), React__default.createElement(NavbarContent, {
    className: 'md:fixed md:left-3',
    justify: "start"
  }, React__default.createElement(NavbarBrand, null, React__default.createElement(Image, {
    src: "/cent-black.png",
    className: "h-20 w-20"
  }))), React__default.createElement(NavbarContent, {
    className: 'md:fixed md:right-10',
    justify: "end"
  }, React__default.createElement(NavbarItem, null, React__default.createElement(Dropdown, null, React__default.createElement(DropdownTrigger, null, React__default.createElement(Avatar, {
    showFallback: true,
  ...
  })), React__default.createElement(DropdownMenu, null, React__default.createElement(DropdownItem, null, "Perfil"), React__default.createElement(DropdownItem, {
    showDivider: true
  }, "Pagamentos"), React__default.createElement(DropdownItem, {
    className: "text-red-500",
    onClick: function onClick() {
      return signOut();
    }
  }, "Sair"))))), React__default.createElement(NavbarMenu, null, linkItems.map(function (item, index) {
    return React__default.createElement(NavbarMenuItem, {
      key: item.view + "-" + index
...
function TableCrud(_ref) {
  ...
  var _useState4 = useState(columns.filter(function (column) {
  ...
  var onRowsPerPageChange = useCallback(function (e) {
  ...
  var _onClear = useCallback(function () {
    setFilterValue("");
    setPage(1);
  }, []);
  var bottomContent = useMemo(function () {
    return React__default.createElement("div", {
      className: "py-2 px-2 flex justify-between items-center w-full"
    }, React__default.createElement("span", {
      className: "text-default-400 text-small"
    }, "Total ", items.length), React__default.createElement(Pagination, {
      isCompact: true,
      showControls: true,
      showShadow: true,
      color: "primary",
  ...
  var renderCell = useCallback(function (element, columnKey, isMobile, item) {
    ...
    switch (column.type) {
      case "user":
        return React__default.createElement(User, {
          avatarProps: {
            radius: "lg",
            name: element.name,
            isBordered: true
      ...
      case "actions":
        if (isMobile) {
          return React__default.createElement(Dropdown, null, React__default.createElement(DropdownTrigger, null, React__default.createElement(Button, {
            variant: "light",
            isIconOnly: true,
            radius: "full"
          }, React__default.createElement(AiOutlineMore, {
            className: "w-6 h-16"
          ...
          }, React__default.createElement(DropdownItem, {
            key: "new",
            startContent: React__default.createElement(ViewUser, null)
          }, "Detalhes"), React__default.createElement(DropdownItem, {
            key: "copy",
            startContent: React__default.createElement(FaUserEdit, null)
          }, "Editar ", elementName), React__default.createElement(DropdownItem, {
            key: "edit",
            className: "text-danger",
            color: "danger",
            startContent: React__default.createElement(AiOutlineUserDelete, null)
          }, "Deletar ", elementName)));
        } else if (!isMobile) {
          return React__default.createElement("div", {
          ...
          }, React__default.createElement(ViewUser, null))), React__default.createElement(Tooltip, {
            content: "Editar " + elementName
          }, React__default.createElement("span", {
            className: "text-lg text-default-400 cursor-pointer active:opacity-50"
          }, React__default.createElement(FaUserEdit, null))), React__default.createElement(Tooltip, {
            color: "danger",
            content: "Excluir " + elementName
          }, React__default.createElement("span", {
            className: "text-lg text-danger cursor-pointer active:opacity-50"
          }, React__default.createElement(AiOutlineUserDelete, null))));
        }
        break;
      default:
        return cellValue;
  ...
  var topContent = useMemo(function () {
    return React__default.createElement("div", {
      ...
      startContent: React__default.createElement(CiSearch, null),
      value: filterValue,
  ...
  return React__default.createElement(Table, {
    ...
    return React__default.createElement(TableColumn, {
      key: column.uid,
    ...
    loadingContent: React__default.createElement(Spinner, null),
    loadingState: loadingState
  }, function (item) {
    return React__default.createElement(TableRow, {
      key: item.clients
    }, function (columnKey) {
      return React__default.createElement(TableCell, null, renderCell(item, columnKey, isMobile, item));
    });
  }));
}
...
export { ExampleComponent, MainArea, SideBar, TableCrud };
