...
const CustomDrawer: React.FC<Props> = ({ direction, ...props }) => {
  ...
  const styleDrawer: CSSProperties = {
    ...
    width: isMobile ? '100%' : '25rem',  // Ocupa 100% da largura em dispositivos móveis
    position: 'fixed',
  ...
  return (
    <>
      <Drawer
        open={props.lengthFiles ? true : false}
      ...
      >
        ...
        >
          <div className="h-full flex items-center justify-between">
            <p className="pl-4">{props.lengthFiles} Arquivo(s) para upload.</p>
